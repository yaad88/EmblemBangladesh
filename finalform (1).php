...
if(isset($_POST['eid']) && isset($_POST['filterNo']))
{
  ...
  $selectedEmblem=$row['File'.$filterNo];
}
else
...
<body>
 <header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent justify-content-center">
      ...
      <a class="navbar-brand ml-4" href="index.html"><img src="images/logo.png" height="60px" alt="yaad" class="img-fluid"></a>
    ...
    <form method="post" id="form8" action="finalform.php">
        <div class="wrapper">

              <input type="hidden" name="filterNo" value="<?php echo $temp;?>">
              <input type="hidden" name="eid" value="<?php echo $eid;?>">
                      
              <button class="dload">Select Another Photo</button></a>
              </div>
        </div>
  </form>   
    ...
    <div class="banner">
      ...
      <div class="demo">
        ...
        <img class="image2"height="200px" width="200px" style="margin-bottom:20px;" src="<?php echo $selectedEmblem;?>" alt="emblem" />
        <br />
